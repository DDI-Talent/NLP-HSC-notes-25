...
person_entity(wiki)
# Heads up: if you see error about JAVA_HOME read ethe note below
```
### Small note about JAVA_HOME for people running this on their own laptops (only important if you see ...JAVA_HOME error above)

If you;re running this on your own Laptop you might see code above fail with ''

That happens because some libraries use specific universal programming language called Java, and your Rstudio cannot find where it is (where is Java's home). This can happen specifically if your rstudio or computer is using x64 architecture, but your java uses x32. To find out check your R version in terminal with `R.version` and your Java version in terminal with `java -version`. You probably want both of them to mention something about 64 bits. If your java is 32 bits, you might want to download 64bit version from here: https://www.java.com/en/download/manual.jsp 
